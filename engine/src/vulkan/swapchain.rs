...
use super::{context::VulkanContext, instance::VulkanInstance};
...
impl VulkanSwapchain {
    ...
    pub unsafe fn create_swapchain(
        ...
        let support = VulkanSwapchain::get(instance, context, context.physical_device)?;

        let surface_format = VulkanSwapchain::get_swapchain_surface_format(&support.formats);
        let present_mode = VulkanSwapchain::get_swapchain_present_mode(&support.present_modes);
        let extent = VulkanSwapchain::get_swapchain_extent(window, support.capabilities);
